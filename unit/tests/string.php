...
//-------------------------//
// Test 1
$string = Eden_String::i("Unit Test Eden V2");
...
//Test 1
//-------------------->
$string = Eden_String::i("Unit Test for Dan's Window");
...
//Test 2
//--------------------->
$string = Eden_String::i("Unit Test");
...
//Test 3
//--------------------->
$string = Eden_String::i("I'll make a 'history!'");
...
//Test 4
//--------------------->
$string = Eden_String::i("Have a good Day!");
...
//Test 5
//--------------------->
$string = Eden_String::i("\t\tThese are a few words");
...
$string = Eden_String::i("%d word for sprintf %s");
$d = 2;
$s = "data";
...
$string = Eden_String::i("Returns the matched");
...
$string = Eden_String::i("programming techniques ");

...
class Eden_Google_Oauth extends Eden_Oauth2_Client {
	...
	const SCOPE_LATITUDE_ALL_BEST 		= 'https://www.googleapis.com/auth/latitude.all.best';
	const SCOPE_LATITUDE_ALL_CITY 		= 'https://www.googleapis.com/auth/latitude.all.city';
	const SCOPE_LATITUDE_CURRENT_BEST	= 'https://www.googleapis.com/auth/latitude.current.best';
	const SCOPE_LATITUDE_CURRENT_CITY 	= 'https://www.googleapis.com/auth/latitude.current.city';
	...
	protected $_scopes = array(	
		...
		'h9' 					=> self::SCOPE_H9,
		'latitude_all_best' 	=> self::SCOPE_LATITUDE_ALL_BEST,
		'latitude_all_city' 	=> self::SCOPE_LATITUDE_ALL_CITY,
		'latitude_current_best' => self::SCOPE_LATITUDE_CURRENT_BEST,
